...
<body>
  <div class="tabs-content">
    ...
    <div class="tabs-data active">
      <?php 
        $select = "SELECT * FROM recipes JOIN users ON recipes.id=users.id JOIN categories ON recipes.cate_id=categories.id  WHERE cate_id = 2 ORDER BY recipes.rid LIMIT 3";
    ...
    <div class="tabs-data">
      <?php 
        $select = "SELECT * FROM recipes JOIN users ON recipes.id=users.id JOIN categories ON recipes.cate_id=categories.id  WHERE cate_id = 1 ORDER BY recipes.rid LIMIT 3";
        $exe = mysqli_query($conn,$select);
        if(mysqli_num_rows($exe)>0){
      ?>
      <div class="cards">
          ...
          ?>
            <div class="card-container">
              ...
              <div class="card-footer">
                ...
                <?php if(!empty($_SESSION['Username'])){ ?>
                <div class="card-save">
                  <a href="../crud(php)/favourites/save.php?rid=<?php echo $row['rid'];?>&uname=<?php echo $_SESSION['Username'];?>" class="fav-btn">
                    <svg
                            xmlns="http://www.w3.org/2000/svg"
                            width="24"
                            height="24"
